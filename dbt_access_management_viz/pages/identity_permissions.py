...
identity_name = st.selectbox("Select an identity to get assigned permissions", options=[""] + list(permission_tables["identity_name"]))

if identity_name:
    per_identity_permissions = redshift_service.get_all_permissions_for_identity(identity_name=identity_name)
